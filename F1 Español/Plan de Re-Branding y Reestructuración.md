Este documento contiene una guía de fácil comprensión sobre la reinvención del Servidor F1 Español. La lectura es obligatoria para todo el equipo de moderación.

*Objetivo principal:* Revitalizar la comunidad implementando una nueva identidad visual, purgando canales y un evento de relanzamiento. Asegurar un entorno activo, organizado y atractivo para la temporada actual y la siguiente de la Fórmula 1.
...
- **Limpieza y estructura de canales**
	- *[[Estructura de canales]]:* Eliminar o archivar canales inactivos. El exceso de estos canales vacíos genera una percepción de inactividad.
